...
export default {
  ...
  methods: {
    ...
    // 提交订单
    async submitOrder() {
      let { tradeNo } = this.orderInfo // 交易的编码
      let data = {
        consignee: this.userDefaultAddress.consignee,// 最终收件人姓名
        consigneeTel: this.userDefaultAddress.phoneNum, // 最终收货手机号
        deliveryAddress: this.userDefaultAddress.fullAddress,// 最终收货地址
